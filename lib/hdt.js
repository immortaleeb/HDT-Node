...
function createEntitiesContainer(hdtDocument, iteratorFunction, sizeFunction) {
  return {
    ...
    forEach: function (entityCallback, doneCallback) {
      ...
      function getNextEntity() {
        it.next(function (entity) {
          ...
          if (entity === null) return doneCallback && doneCallback(index);
...
HdtDocumentPrototype.shared = function() {
  return createEntitiesContainer(this, HdtDocumentPrototype._sharedIterator, HdtDocumentPrototype._getNShared);
};
