...
function createEntitiesContainer(hdtDocument, iteratorFunction) {
  return {
...
HdtDocumentPrototype.subjects = function() {
  return createEntitiesContainer(this, HdtDocumentPrototype._subjectsIterator);
};

HdtDocumentPrototype.objects = function() {
  return createEntitiesContainer(this, HdtDocumentPrototype._objectsIterator);
};

HdtDocumentPrototype.predicates = function() {
  return createEntitiesContainer(this, HdtDocumentPrototype._predicatesIterator);
};
